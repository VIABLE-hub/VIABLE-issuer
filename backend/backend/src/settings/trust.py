...
from .core import get_current_tenant, create_settings_backup
...
def api_trust_settings():
    ...
    if request.method == "GET":
        ...
        try:
            ...
            # Create backup
            create_settings_backup(tenant_id, "auto", "Before trust settings update")
            
            # Update settings
            tenant_settings.trust_settings = data
            db.session.commit()
...
def register_routes(blueprint):
    ...
    def settings_trust_add_issuer():
        ...
        try:
            ...
            if issuer not in trust_settings["trust"]["trusted_issuers"]:
                ...
                # Update settings
                tenant_settings.trust_settings = trust_settings
                db.session.commit()
    ...
    def api_trust_issuers():
        ...
        try:
            ...
            trust_settings = tenant_settings.trust_settings or {"trust": {"trusted_issuers": []}}
    ...
    def api_trust_schemas():
        ...
        try:
            ...
            # Get current trust settings or use defaults
            trust_settings = tenant_settings.trust_settings or {"trust": {"trusted_schemas": []}}
            if "trust" not in trust_settings:
    ...
    def api_trust_verify():
        ...
        try:
            ...
            # Get current trust settings or use defaults
            trust_settings = tenant_settings.trust_settings or EMERGENCY_TRUST_DATA
            ...
            if issuer_id:
                for issuer in trust_settings.get("trusted_issuers", []):
            ...
            if schema_id:
                for schema in trust_settings.get("trusted_schemas", []):
