...
def get_placeholders(logo_filename="studentVC-logo-sora-cropped-darkmode.png", profile_filename="student.png"):
    ...
    # Absoluter Fallback auf das externe student.png
    if not os.path.exists(profile_path):
        external_profile_path = "/Users/patrickherbke/Downloads/student.png"
        if os.path.exists(external_profile_path):
            profile_path = external_profile_path
            logger.info(f"🩺 Profile external fallback to: {profile_path}")
