...
class Config:
    ...
    UNIVERSITY_SHORT_NAME = "VIABLE"
    PRIMARY_COLOR = "#F0D722"
    ACCENT_COLOR = "#F0D722"
    TEXT_COLOR = "#FFFFFF"
    
    # Logos
    LOGO_FILENAME = "VIABLE_Logo_07.2021.svg"
    HOCHSCHUL_BRANDING_LOGO = "VIABLE_Logo_07.2021.svg"
    MAIN_LOGO_FILENAME = "VIABLE_Logo_07.2021.svg"
    ...
    ISSUER_DID = os.environ.get("ISSUER_DID", "did:web:viable.viable-id.com")
